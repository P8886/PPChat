...
create table public.messages (
  ...
  file_hash_id  bigint references public.file_hashes(id)
);
comment on table public.messages is 'Individual messages sent by each user.';
comment on column public.messages.message_type is 'Message type: text or image';
comment on column public.messages.file_hash_id is 'Reference to file_hashes table for duplicate file management';
...
comment on table public.file_hashes is 'File hash values for duplicate file management.';
comment on column public.file_hashes.hash_value is 'SHA-256 hash of the file content';
comment on column public.file_hashes.file_path is 'Path of the file in storage';
comment on column public.file_hashes.reference_count is 'Number of messages referencing this file';
